export const translations = {
  fr: {
    ...
    continuePayment: 'Continuer vers le paiement Zeffy',
    continueZeffyPayment: 'Payer en toute sécurité avec Zeffy',
    zeffyPaymentReady: 'Votre inscription est enregistrée. Vérifiez le solde ci-dessus, puis terminez le paiement sécurisé avec Zeffy.',
    paymentProviderBlocked: 'Le paiement est temporairement indisponible : Jouer Pour de Bon accepte uniquement les liens de paiement sécurisés Zeffy.',
    ...
    unavailableEvent: 'Événement indisponible.',
    missingRegistrationLink: 'Cet événement n’est pas encore relié à une inscription.',
    missingOrganizerCause: 'La cause choisie par l’organisateur est manquante.',
    unapprovedCause: 'La cause de cet événement doit être reliée à une cause approuvée dans Jouer Pour de Bon.',
    registrationClosed: 'Les inscriptions sont fermées pour cet événement.',
  ...
  en: {
    ...
    continuePayment: 'Continue to Zeffy payment',
    continueZeffyPayment: 'Pay securely with Zeffy',
    zeffyPaymentReady: 'Your registration is recorded. Review the balance above, then complete secure payment with Zeffy.',
    paymentProviderBlocked: 'Payment is temporarily unavailable: Playing For Good accepts only secure Zeffy payment links.',
    ...
    unavailableEvent: 'Event unavailable.',
    missingRegistrationLink: 'This event is not connected to registration yet.',
    missingOrganizerCause: 'The organizer-selected cause is missing.',
    unapprovedCause: 'This event’s cause must be connected to an approved Playing For Good cause.',
